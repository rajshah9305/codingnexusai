...
describe('API Integration Tests', () => {
  ...
  describe('POST /api/generate', () => {
    ...
    it('should handle default type', async () => {
      const mockResult = { code: ['test'], explanation: 'test', language: 'javascript', model: 'claude-4-sonnet' };
      bedrockService.generateCode.mockResolvedValue(mockResult);
  ...
  describe('JSON Parsing', () => {
    it('should parse JSON request bodies', async () => {
      bedrockService.generateCode.mockResolvedValue({ code: [], explanation: '', language: 'javascript', model: 'claude-4-sonnet' });
