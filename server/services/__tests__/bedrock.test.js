...
describe('BedrockService', () => {
  ...
  describe('constructor', () => {
    ...
    it('should have correct model mappings', () => {
      expect(service.models).toHaveProperty('claude-4-sonnet');
      expect(service.models).toHaveProperty('titan-text');
    });
  });
  ...
  describe('generateCode', () => {
    it('should generate code using Claude model', async () => {
      ...
      const result = await service.generateCode('Create a hello world variable', 'claude-4-sonnet');
    ...
    it('should handle errors gracefully', async () => {
      ...
      await expect(
        service.generateCode('Test prompt', 'claude-4-sonnet')
  ...
  describe('getProvider', () => {
    it('should return correct provider for each model type', () => {
      expect(service.getProvider('claude-4-sonnet')).toBe('Anthropic');
